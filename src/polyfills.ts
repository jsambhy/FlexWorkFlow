...
//After install @types/nodes for getting AWS
if (typeof (window as any).global === 'undefined') { (window as any).global = window; }

//After install buffer which was needed after install speakeasy for google authentication
global.Buffer = global.Buffer || require('buffer').Buffer;

//After installing process which was needed after installing buffer
